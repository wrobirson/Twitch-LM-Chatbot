...
export default function AccountView({className = ''}: {className?: string}) {
    ...
    return (
        <Card className={className} loading={accountQuery.isLoading}>
            ...
            {accountQuery.isSuccess && !accountQuery.data  && (
                <>
                    <div className="text-center py-11">{t('You do not have a linked Twitch account.')}</div>
                    <div className="text-center">
