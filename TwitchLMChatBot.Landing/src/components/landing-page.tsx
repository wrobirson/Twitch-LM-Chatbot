    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <a className="flex items-center justify-center" href="#">
          <img src='/chatbot.png' className="h-6 w-6" />
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-600 md:text-xl">
                  Twitch LM Chatbot uses advanced language models to interact with your viewers and create engaging experiences.
                </p>
              </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500">© 2023 Twitch LM Chatbot by <a href="https://github.com/wrobirson">wrobirson</a> All rights reserved.</p>
